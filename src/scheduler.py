...
BOT_CONFIG = {
	...
	"1315448025593679913": (MISSING, MISSING, "TOKEN_QU3FTUHXFQBMCHUL9FLRK9BMPWR2"),
	"1326249096771801219": (MISSING, MISSING, "TOKEN_5RZDKVQ36JEOO81ZNOCIDCQWS3V1"),
	"1326339779771502652": (MISSING, MISSING, "TOKEN_0N8A9FGOX7CWNPW5L7B3DSSM89C3"),
	"1327811465482080298": (MISSING, MISSING, "TOKEN_FWEMDMBHZ2OAGT326MPWWQ7MXGS1")
}
